...
-- Short-lived administrator-generated codes pair a standalone kiosk once.
...
-- Long random kiosk tokens are stored only as keyed hashes. Employees never
-- sign in on the paired kiosk computer.
