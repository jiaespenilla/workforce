...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="fixed inset-x-3 top-[4.5rem] z-50 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl ring-1 ring-slate-900/5 sm:absolute sm:inset-x-auto sm:right-0 sm:top-12 sm:w-80">
