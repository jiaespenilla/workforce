...
const ADMIN_NAV = [
  ...
  { to: '/shifts', label: 'Shift Schedules', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { to: '/time-clock-setup', label: 'Time Clock Setup', icon: 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z' },
      ...
      <header className="sticky top-0 z-40 flex h-16 items-center justify-between gap-2 border-b border-gray-200 bg-white px-3 sm:px-4 lg:px-8">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <div className="min-w-0 leading-tight">
            ...
            <p className="truncate text-[11px] text-gray-500">System Administration</p>
          </div>
        </div>
        <div className="flex items-center gap-2.5">
          ...
          <button type="button" onClick={() => navigate('/profile')} title="My profile" aria-label="Open my profile" className="touch-44 flex items-center gap-2.5 rounded-full p-0.5 pr-2 transition hover:bg-gray-100">
