...
// NOTE: no 'storage' key — Storage Setup is administrator-only by design (19),
// not a per-role permission.
const PAGE_KEYS = ['dashboard', 'timekeeping', 'tasks', 'payroll', 'employees', 'shifts']

// Fill in missing permission keys, migrate the old single "mainMenu" flag,
// and discard retired shared-kiosk permissions.
